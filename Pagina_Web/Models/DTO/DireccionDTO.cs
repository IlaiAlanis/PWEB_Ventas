...
namespace Pagina_Web.Models.DTO
{
    ...
    public partial class DireccionDTO
    {
        ...
        public virtual EstadoDTO IdEstUsuarioNavigation { get; set; } = null!;
        [ForeignKey("IdMunUsuario")]
        [InverseProperty("Direccions")]
        public virtual MunicipioDTO IdMunUsuarioNavigation { get; set; } = null!;
        [InverseProperty("IdDirNavigation")]*/
        public virtual ICollection<ApplicationUserDTO> Usuarios { get; set; }
    }
}
