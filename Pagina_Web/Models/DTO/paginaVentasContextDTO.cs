...
{
    public partial class paginaVentasContextDTO : IdentityDbContext<ApplicationUserDTO, IdentityRole<int>, int>
    {
        public paginaVentasContextDTO()
        {
        }

        public paginaVentasContextDTO(DbContextOptions<paginaVentasContextDTO> options)
            : base(options)
        {
        }

        /*public virtual DbSet<Cargo> Cargos { get; set; } = null!;*/
        public virtual DbSet<CarritoDTO> Carritos { get; set; } = null!;
        public virtual DbSet<CategoriaProductoDTO> CategoriaProductos { get; set; } = null!;
        public virtual DbSet<DetalleVpDTO> DetalleVps { get; set; } = null!;
        public virtual DbSet<DireccionDTO> Direccions { get; set; } = null!;
        /*public virtual DbSet<EstadoDTO> Estados { get; set; } = null!;*/
        public virtual DbSet<MarcaProductoDTO> MarcaProductos { get; set; } = null!;
        /*public virtual DbSet<MunicipioDTO> Municipios { get; set; } = null!;*/
        public virtual DbSet<PagoDTO> Pagos { get; set; } = null!;
        public virtual DbSet<ProductoDTO> Productos { get; set; } = null!;
        /*public virtual DbSet<Usuario> Usuarios { get; set; } = null!;*/
        public virtual DbSet<VentumDTO> Venta { get; set; } = null!;
       ...
       protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CarritoDTO>(entity =>
            {
            ...
            modelBuilder.Entity<DetalleVpDTO>(entity =>
            {
            ...
            modelBuilder.Entity<DireccionDTO>(entity =>
            {
            ...
            /*modelBuilder.Entity<EstadoDTO>(entity =>
            {
                entity.HasKey(e => e.IdEstado)
                    .HasName("PK__Estado__86989FB27929A05F");
            });

            modelBuilder.Entity<MarcaProductoDTO>(entity =>
            {
                entity.HasKey(e => e.IdMarca)
                    .HasName("PK__Marca_Pr__7E43E99E37A4CAA5");
            });

            modelBuilder.Entity<MunicipioDTO>(entity =>
            {
           ...
           modelBuilder.Entity<VentumDTO>(entity =>
            {
